        ...
        <div className="relative mx-auto max-w-6xl px-5 sm:px-6">
          <ScrollReveal>
            ...
            <p className="mt-5 max-w-2xl text-lg text-mist-muted">
              From AI integration and RPA to web, mobile, cloud, and enterprise systems - explore
              each capability in depth, then book a consultation when you’re ready.
            </p>
            <div className="mt-8">
              <ConsultButton />
            </div>
          ...
          {services.map((service, i) => {
            ...
            return (
              <ScrollReveal key={service.slug} delay={i * 0.05}>
                <motion.div whileHover={{ y: -6 }} transition={{ type: 'spring', stiffness: 360, damping: 24 }}>
                  <Link
